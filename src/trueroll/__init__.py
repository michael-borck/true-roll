...
# Define an __all__ list to restrict what is exported when someone uses from trueroll import *
__all__ = [
    "Bowler",
    "Alley",
    "Game",
...
def run_tui():
    ...
    from trueroll.tui.app import run_app
    run_app()

def run_web(host="127.0.0.1", port=8000, debug=False):
    """Run the web interface."""
    from trueroll.web.app import run_server
